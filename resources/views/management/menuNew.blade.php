...
@include('layouts.goBack')
    ...
    <h1 class="mt-3">Creating Menu</h1>
    ...
    <div class="input-group mb-3">
      ...
      <input id="dengan-rupiah" type="text" class="form-control" value="{{ number_format(0, 0, '','.') }}" name="price" aria-describedby="basic-addon1">
    </div>
          ...
          The image should not be over 1mb <br> Image ratio is recomended to be 3:2 <br> Image size recomended is 295px x 210px
                    ...
                    <div class="form-check">
                        <div class="d-flex flex-row-reverse py-4" >
                            <button type="submit" class="btn btn-outline-success">Create Menu</button>
                        </div>
                    </div>
</form>
